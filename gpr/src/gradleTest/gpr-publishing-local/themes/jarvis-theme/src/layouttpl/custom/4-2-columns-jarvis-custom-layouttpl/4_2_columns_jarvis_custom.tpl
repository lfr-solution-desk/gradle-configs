<div class="4-2-columns-jarvis-custom" id="main-content" role="main">
	<div class="panel-row portlet-layout row">
	...
	<div class="portlet-layout row">
		...
		<div class="col-md-6 portlet-column portlet-column-last" id="column-6">
