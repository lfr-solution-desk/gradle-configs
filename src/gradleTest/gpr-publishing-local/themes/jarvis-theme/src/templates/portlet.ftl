...
<section class="portlet" id="portlet_${portlet_id}">
	...
	<div class="${portlet_content_css_class}">
		...
		<#if portlet_display.getPortletDecoratorId() == "card">
			<div class="heading portlet-title-text">${portlet_title}</div>
		<#elseif portlet_display.getPortletDecoratorId() != "barebone" && portlet_display.getPortletDecoratorId() != "cardNoTitle">
